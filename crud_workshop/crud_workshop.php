       ...
       <div id="left" >
        ...
        <table class="table table-bordered table-hover">
            ...
            <?php
                ...
                $query=mysqli_query($link,"select * from `addedworkshop`");
                        ...
                        <td>
                            <div class="btn-group">
                              ...
                              <ul class="dropdown-menu">
                                <a href="#edit<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-warning"><span class="fa icon-edit"></span> Edit</a>  
                                <a href="#del<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="fa icon-trash"></span> Delete</a>
                              </ul>
                            </div>
